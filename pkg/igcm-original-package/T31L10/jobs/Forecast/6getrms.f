CC get initial confdition
	...
	outfile='/mnt/climate/data/loach/jiaxj/Data/SGCM/OutData/AONAO/Prediction/NewdampData/OUTpred_total.dat'
...
cc convert from character to integer--
 	...
 	open(12,file='fort.51', form='unformatted')
        open(13,file='fort.41',form='unformatted',status='old')
