...
C                                                                          PARAM1.4     
      PARAMETER(NN=31,MM=31,NHEM=2,NL=10,MOCT=1,MG=96,JG=24,NWJ2=256       G100.1     
...
C                                                                          MLTRI.208   
      ...
      ENDIF                                                                MLTRI.215   
C                                                                          MLTRI.216   
      IF (LTRAIN.AND.(KTRAIN.LT.90*52)) GO TO 111                          NICK.133   
      STOP                                                                 MLTRI.217   
      END                                                                  MLTRI.218   
...
C           ENDIF                                                          NICK.233   
         ...
         IF (LFAN) THEN                                                    NICK.235   
            ...
            IF (LLIN) THEN                                                 NICK.238   
               DO I=1,IGB                                                  NICK.239   
               ZFAN(I)=ZFAN(I)/1.E2                                        NICK.240   
               DFAN(I)=DFAN(I)/1.E2                                        NICK.241   
               TFAN(I)=TFAN(I)/1.E2                                        NICK.242   
               ENDDO                                                       NICK.243   
               DO I=1,IGA                                                  NICK.244   
               SPFAN(I)=SPFAN(I)/1.E2                                      NICK.245   
               ENDDO                                                       NICK.246   
            ENDIF                                                          NICK.247   
         END IF                                                            NICK.248   
C     END IF                                                               NICK.249   
...
C*****FORCING                                                              NICK.301   
   ...
   43 CONTINUE                                                             NICK.322   
      ...
      ZT(I)=ZT(I) + ZFAN(I)                                                NICK.327   
      DT(I)=DT(I) + DFAN(I)                                                NICK.328   
      TT(I)=TT(I) + TFAN(I)                                                NICK.329   
   44 CONTINUE                                                             NICK.330   
      DO 45 I=1,IGA                                                        NICK.331   
      VP(I)=VP(I) + SPFAN(I)                                               NICK.332   
...
C*****DAMPING                                                              NICK.378   
                                                                           NICK.379   
      DAMP2=1.0/(PI2*30.)                                                  NICK.380   
C     DAMP2=DAMP/25                                                        NICK.381   
                                                                           NICK.382   
C*****stratosphere                                                         NICK.383   
      DO 51 I=1,IGA                                                        NICK.384   
      ZT(I)=ZT(I) - DAMP2*Z(I)                                             NICK.385   
      DT(I)=DT(I) - DAMP2*D(I)                                             NICK.386   
      TT(I)=TT(I) - DAMP2*T(I) *3.                                         NICK.387   
   51 CONTINUE                                                             NICK.388   
                                                                           NICK.389   
C*****troposphere                                                          NICK.390   
      DO 52 I=IGA+1,(NL-2)*IGA                                             NICK.391   
      ZT(I)=ZT(I) - DAMP2*Z(I)                                             NICK.392   
      DT(I)=DT(I) - DAMP2*D(I)                                             NICK.393   
      TT(I)=TT(I) - DAMP2*T(I) *3.                                         NICK.394   
   52 CONTINUE                                                             NICK.395   
                                                                           NICK.396   
C*****upper boundary layer (fix later for LS contrast)                     NICK.397   
      DO I=(NL-2)*IGA+1,(NL-1)*IGA                                         NICK.398   
      ZT(I)=ZT(I) - DAMP*Z(I)*0.5                                          NICK.399   
      DT(I)=DT(I) - DAMP*D(I)*0.5                                          NICK.400   
      TT(I)=TT(I) - DAMP*T(I)*0.5*AAT                                      NICK.401   
      ENDDO                                                                NICK.402   
                                                                           NICK.403   
C*****lower boundary layer (possibility of LS contrast)                    NICK.404   
      IF (LGPDAMP.NE.1) THEN                                               NICK.405   
      DO 53 I=(NL-1)*IGA+1,IGB                                             NICK.406   
      ZT(I)=ZT(I) - DAMP*Z(I)*1.5                                          NICK.407   
      DT(I)=DT(I) - DAMP*D(I)*1.5                                          NICK.408   
   53 CONTINUE                                                             NICK.409   
      END IF                                                               NICK.410   
                                                                           NICK.411   
      DO 54 I=(NL-1)*IGA+1,IGB                                             NICK.412   
      TT(I)=TT(I) - DAMP*T(I)*1.5*AAT                                      NICK.413   
   54 CONTINUE                                                             NICK.414   
                                                                           NICK.415   
C*****optional extra damping of upper level zonal means                    NICK.416   
C*****stratosphere                                                         NICK.417   
C     K=1                                                                  NICK.418   
C     DO I=1,IDM                                                           NICK.419   
C     II=IGA*(K-1)+I                                                       NICK.420   
C     ZT(II)=ZT(II) - DAMP*Z(II)*(1.-0.)                                   NICK.421   
C     DT(II)=DT(II) - DAMP*D(II)*(1.-0.)                                   NICK.422   
C     TT(II)=TT(II) - DAMP*T(II)*(1.-0.1)                                  NICK.423   
C     II=IGA*(K-1)+I+NWJ2                                                  NICK.424   
C     ZT(II)=ZT(II) - DAMP*Z(II)*(1.-0.)                                   NICK.425   
C     DT(II)=DT(II) - DAMP*D(II)*(1.-0.)                                   NICK.426   
C     TT(II)=TT(II) - DAMP*T(II)*(1.-0.)                                   NICK.427   
C     ENDDO                                                                NICK.428   
                                                                           NICK.429   
C*****troposphere                                                          NICK.430   
C     DO K=2,(NL-1)                                                        NICK.431   
C     DO I=1,IDM                                                           NICK.432   
C     II=IGA*(K-1)+I                                                       NICK.433   
C     ZT(II)=ZT(II) - DAMP*Z(II)*(0.1-0.)                                  NICK.434   
C     DT(II)=DT(II) - DAMP*D(II)*(0.1-0.)                                  NICK.435   
C     TT(II)=TT(II) - DAMP*T(II)*(0.1-0.1)                                 NICK.436   
C     II=IGA*(K-1)+I+NWJ2                                                  NICK.437   
C     ZT(II)=ZT(II) - DAMP*Z(II)*(0.1-0.)                                  NICK.438   
C     DT(II)=DT(II) - DAMP*D(II)*(0.1-0.)                                  NICK.439   
C     TT(II)=TT(II) - DAMP*T(II)*(0.1-0.1)                                 NICK.440   
C     ENDDO                                                                NICK.441   
C     ENDDO                                                                NICK.442   
                                                                           NICK.443   
C*****remove damping from planetary vorticity !                            NICK.444   
C*****stratosphere                                                         NICK.445   
      K=1                                                                  NICK.446   
      I=(K-1)*IGA + 1                                                      NICK.447   
      ZT(I)=ZT(I) + DAMP2*EZ                                               NICK.448   
                                                                           NICK.449   
C*****troposphere                                                          NICK.450   
      DO 61 K=2,NL-2                                                       NICK.451   
      I=(K-1)*IGA + 1                                                      NICK.452   
      ZT(I)=ZT(I) + DAMP2*EZ                                               NICK.453   
   61 CONTINUE                                                             NICK.454   
                                                                           NICK.455   
C*****upper boundary layer                                                 NICK.456   
      I=(NL-2)*IGA + 1                                                     NICK.457   
      ZT(I)=ZT(I) + DAMP*EZ*0.5                                            NICK.458   
                                                                           NICK.459   
C*****lower boundary layer                                                 NICK.460   
      I=(NL-1)*IGA + 1                                                     NICK.461   
      IF (LGPDAMP.NE.1) ZT(I)=ZT(I) + DAMP*EZ*1.5                          NICK.462   
                                                                           NICK.463   
      ENDIF                                                                NICK.464   
C                                                                          DIFUSE.56    
