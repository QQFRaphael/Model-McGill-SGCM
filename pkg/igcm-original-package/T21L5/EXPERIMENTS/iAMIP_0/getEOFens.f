	Parameter ( nm=51, ng=36*14, nEmax=10)
     ...
     * 'Pmsl.dat',
     &   form='unformatted',status='old')
      ...
      open(23,file='tmpEOF',form='unformatted')
...
16	tm(i,j)=0.
	do 61 k=1,nm*20
	 ...
	 do 12 i=1,72
	 do 12 j=1,15
12	 tm(i,j)=tm(i,j)+t(i,j)/float(nm*20)
61	continue
...
c   of a real symmetric matrix of order nm using Eispack routines
  ...
  60            continue
      ...
      open  (2, file='percentEOF_Pmsl.dat')
