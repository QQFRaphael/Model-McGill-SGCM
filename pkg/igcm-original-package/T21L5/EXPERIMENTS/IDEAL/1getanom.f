C from rimbaud:/usr/people/hall/data/T31L10/makeanom.f
      ...
      REAL G1(LN,LA),PROFILE(5),SIGMA(5),G2(LN,LA),G(LN,LA)
      DIMENSION IHD(10)
...
C
      G1(I,J)=(-1.3)*AMP*(COS(RR*PI/2.))**2.
      IF (COS(RR*PI/2.).LT.0.) G1(I,J)=0.
 50   CONTINUE
...
C     DEGSPD=5. * 1.E-4
      DEGSPD=2.
      AMP=PROFILE(L) * DEGSPD/12.
      G2(I,J)=(1.3)*AMP*(COS(RR*PI/2.))**2.
      IF (COS(RR*PI/2.).LT.0.) G2(I,J)=0.
 51   CONTINUE
