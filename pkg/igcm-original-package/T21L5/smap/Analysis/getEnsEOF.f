CC EOF  of Ensemble
        ...
        Parameter (ng=36*14, ny=5)
	parameter(nm=30,ns=nm,M=73,N=37,Nrun=30)
...
c	open(17,file='EOF',form='unformatted')
c	open(21, file='/pike/jiaxj/igcm/Result/EXPInt/Z500.dat'
 	open(21, file='Z500.dat'
