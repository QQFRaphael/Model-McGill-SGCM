...
C                                                                          INISTR.45    
C     initialise grid point fields to zero and read if required            NICK.252   
C                                                                          NICK.253   
      IF (KTRAIN.EQ.0) THEN                                                NICK.254   
                                                                           NICK.255   
      DO J=1,JG                                                            NICK.256   
      DO I=1,IGC                                                           NICK.257   
         GG(I,J)=0                                                         NICK.258   
      ...
      ENDDO                                                                NICK.261   
                                                                           NICK.262   
      READ(18)GG                                                           NICK.263   
      READ(19)MASK                                                         NICK.264   
                                                                           NICK.265   
C     work out area averages of terms in drag coeff for normalization      NICK.266   
                                                                           NICK.267   
      RMASKAVE=0.                                                          NICK.268   
      FHAVE=0.                                                             NICK.269   
      CSAVE=0.                                                             NICK.270   
      DO J=1,JG                                                            NICK.271   
      DO IHEM=1,NHEM                                                       NICK.272   
      DO II=1,MG                                                           NICK.273   
         I=II+(IHEM-1)*MGPP                                                NICK.274   
         RMASKAVE=RMASKAVE+REAL(MASK(I,J))*CS(J)/REAL(NHEM*MG*JG)          NICK.275   
         FH=MASK(I,J)*(1.-EXP(-GG(I,J)/1000.))                             NICK.276   
         FHAVE=FHAVE+FH*CS(J)/REAL(NHEM*MG*JG)                             NICK.277   
      ENDDO                                                                NICK.278   
      ENDDO                                                                NICK.279   
         CSAVE=CSAVE+CS(J)/REAL(JG)                                        NICK.280   
      ENDDO                                                                NICK.281   
      RMASKAVE=RMASKAVE/CSAVE                                              NICK.282   
      FHAVE=FHAVE/CSAVE                                                    NICK.283   
                                                                           NICK.284   
      PRINT*,'AREA MEAN OF LAND SEA MASK IS = ',RMASKAVE                   NICK.285   
      PRINT*,'AREA MEAN OF OROGRAPHIC DRAG FUNCTION IS = ',FHAVE           NICK.286   
                                                                           NICK.287   
C     define a normalized drag coefficient that makes standard drag        NICK.288   
C     a function of land/sea and orography with area average 1.            NICK.289   
                                                                           NICK.290   
      DO J=1,JG                                                            NICK.291   
      DO I=1,IGC                                                           NICK.292   
         FH=MASK(I,J)*(1.-EXP(-GG(I,J)/1000.))                             NICK.293   
         CD(I,J)=(1. + AA1*REAL(MASK(I,J)) + AA2*FH)                       NICK.294   
     &           /(1. + AA1*RMASKAVE + AA2*FHAVE)                          NICK.295   
      ENDDO                                                                NICK.296   
      ENDDO                                                                NICK.297   
                                                                           NICK.298   
      END IF                                                               NICK.299   
...
C           ENDIF                                                          NICK.233   
         END IF                                                            NICK.234   
CC jxj                                                                     NICK.235   
         IF (LFAN) THEN                                                    NICK.236   
            REWIND(15)                                                     NICK.237   
            READ(15)ZFAN,DFAN,TFAN,SPFAN                                   NICK.238   
            IF (LLIN) THEN                                                 NICK.239   
               DO I=1,IGB                                                  NICK.240   
               ZFAN(I)=ZFAN(I)/1.E2                                        NICK.241   
               DFAN(I)=DFAN(I)/1.E2                                        NICK.242   
               TFAN(I)=TFAN(I)/1.E2                                        NICK.243   
               ENDDO                                                       NICK.244   
               DO I=1,IGA                                                  NICK.245   
               SPFAN(I)=SPFAN(I)/1.E2                                      NICK.246   
               ENDDO                                                       NICK.247   
            ENDIF                                                          NICK.248   
         END IF                                                            NICK.249   
C     END IF                                                               NICK.250   
...
C*****FORCING                                                              NICK.302   
                                                                           NICK.303   
      IF (LFCE) THEN                                                       NICK.304   
      DO 40 I=1,IGB                                                        NICK.305   
      ZT(I)=ZT(I) + ZFCE(I)                                                NICK.306   
      DT(I)=DT(I) + DFCE(I)                                                NICK.307   
      TT(I)=TT(I) + TFCE(I)                                                NICK.308   
   40 CONTINUE                                                             NICK.309   
      DO 41 I=1,IGA                                                        NICK.310   
      VP(I)=VP(I) + SPFCE(I)                                               NICK.311   
   41 CONTINUE                                                             NICK.312   
      END IF                                                               NICK.313   
                                                                           NICK.314   
      IF (LFED) THEN                                                       NICK.315   
      DO 42 I=1,IGB                                                        NICK.316   
      ZT(I)=ZT(I) - ZFED(I)                                                NICK.317   
      DT(I)=DT(I) - DFED(I)                                                NICK.318   
      TT(I)=TT(I) - TFED(I)                                                NICK.319   
   42 CONTINUE                                                             NICK.320   
      DO 43 I=1,IGA                                                        NICK.321   
      VP(I)=VP(I) - SPFED(I)                                               NICK.322   
   43 CONTINUE                                                             NICK.323   
      END IF                                                               NICK.324   
                                                                           NICK.325   
      IF (LFAN) THEN                                                       NICK.326   
      DO 44 I=1,IGB                                                        NICK.327   
      ZT(I)=ZT(I) + ZFAN(I)                                                NICK.328   
      DT(I)=DT(I) + DFAN(I)                                                NICK.329   
      TT(I)=TT(I) + TFAN(I)                                                NICK.330   
   44 CONTINUE                                                             NICK.331   
      DO 45 I=1,IGA                                                        NICK.332   
      VP(I)=VP(I) + SPFAN(I)                                               NICK.333   
   45 CONTINUE                                                             NICK.334   
      END IF                                                               NICK.335   
                                                                           NICK.336   
      IF (LMODE.AND.KOUNT.GE.5) THEN                                       NICK.337   
C*****SCALING DOWN OF ANOMALY IF TOO BIG OR                                NICK.338   
C*****UP IF TOO SMALL FOR LINEAR MODE FINDER                               NICK.339   
      RNORM=0.                                                             NICK.340   
      DO I=IGA+1,2*IGA                                                     NICK.341   
      RNORM=RNORM+(ABS(Z(I)-ZDMP(I)))**2.                                  NICK.342   
      ENDDO                                                                NICK.343   
      RNORM=SQRT(RNORM)                                                    NICK.344   
      IF (KOUNT.EQ.5) THEN                                                 NICK.345   
      MODEFIND=0                                                           NICK.346   
      RNORM0=1.E-5                                                         NICK.347   
      PRINT*,'RNORM0=',RNORM0                                              NICK.348   
      ENDIF                                                                NICK.349   
      RATIO=RNORM/RNORM0                                                   NICK.350   
      PRINT*,' RATIO= ',RATIO,' RNORM= ',RNORM                             NICK.351   
C                                                                          NICK.352   
C*****MAKE SURE MODEL GETS ABOVE RNORM0 THRESHOLD BEFORE                   NICK.353   
C*****STARTING TO USE MODEFINDER                                           NICK.354   
      IF ((RNORM.GT.RNORM0).AND.(MODEFIND.EQ.0)) MODEFIND=1                NICK.355   
C                                                                          NICK.356   
      IF (((RATIO.GT.10.).OR.(RATIO.LT.0.1)).AND.(MODEFIND.GT.0)) THEN     NICK.357   
      PRINT*,'RNORM= ',RNORM,' RATIO= ',RATIO,' ADJUSTING ANOM'            NICK.358   
      WRITE(2,*)'KOUNT= ',KOUNT,' RNORM= ',RNORM,' RATIO= ',RATIO,         NICK.359   
     &' ADJUSTING ANOM'                                                    NICK.360   
      DO I=1,IGB                                                           NICK.361   
      Z(I)=(Z(I)-ZDMP(I))/RATIO + ZDMP(I)                                  NICK.362   
      D(I)=(D(I)-DDMP(I))/RATIO + DDMP(I)                                  NICK.363   
      T(I)=(T(I)-TDMP(I))/RATIO + TDMP(I)                                  NICK.364   
      ZMI(I)=(ZMI(I)-ZDMI(I))/RATIO + ZDMI(I)                              NICK.365   
      DMI(I)=(DMI(I)-DDMI(I))/RATIO + DDMI(I)                              NICK.366   
      TMI(I)=(TMI(I)-TDMI(I))/RATIO + TDMI(I)                              NICK.367   
      ENDDO                                                                NICK.368   
      DO I=1, IGA                                                          NICK.369   
      SP(I)=(SP(I)-SPDMP(I))/RATIO + SPDMP(I)                              NICK.370   
      SPMI(I)=(SPMI(I)-SPDMI(I))/RATIO + SPDMI(I)                          NICK.371   
      ENDDO                                                                NICK.372   
      ENDIF                                                                NICK.373   
                                                                           NICK.374   
      END IF                                                               NICK.375   
                                                                           NICK.376   
      IF(DAMP.GT.0.0) THEN                                                 NICK.377   
                                                                           NICK.378   
C*****DAMPING                                                              NICK.379   
                                                                           NICK.380   
C*****stratosphere                                                         NICK.381   
      DO 51 I=1,IGA                                                        NICK.382   
C     ZT(I)=ZT(I) - DAMP*Z(I)*0.05                                         NICK.383   
C     DT(I)=DT(I) - DAMP*D(I)*0.05                                         NICK.384   
      TT(I)=TT(I) - DAMP*T(I)*0.1                                          NICK.385   
   51 CONTINUE                                                             NICK.386   
                                                                           NICK.387   
C*****troposphere                                                          NICK.388   
      DO 52 I=IGA+1,(NL-1)*IGA                                             NICK.389   
C     ZT(I)=ZT(I) - DAMP*Z(I)*0.05                                         NICK.390   
C     DT(I)=DT(I) - DAMP*D(I)*0.05                                         NICK.391   
      TT(I)=TT(I) - DAMP*T(I)*0.1                                          NICK.392   
   52 CONTINUE                                                             NICK.393   
                                                                           NICK.394   
C*****boundary layer                                                       NICK.395   
      IF (LGPDAMP.NE.1) THEN                                               NICK.396   
      DO 53 I=(NL-1)*IGA+1,IGB                                             NICK.397   
      ZT(I)=ZT(I) - DAMP*Z(I)                                              NICK.398   
      DT(I)=DT(I) - DAMP*D(I)                                              NICK.399   
   53 CONTINUE                                                             NICK.400   
      END IF                                                               NICK.401   
                                                                           NICK.402   
      DO 54 I=(NL-1)*IGA+1,IGB                                             NICK.403   
      TT(I)=TT(I) - DAMP*T(I)*AAT                                          NICK.404   
   54 CONTINUE                                                             NICK.405   
                                                                           NICK.406   
C*****optional extra damping of upper level zonal means                    NICK.407   
C*****stratosphere                                                         NICK.408   
C     K=1                                                                  NICK.409   
C     DO I=1,IDM                                                           NICK.410   
C     II=IGA*(K-1)+I                                                       NICK.411   
C     ZT(II)=ZT(II) - DAMP*Z(II)*(1.-0.)                                   NICK.412   
C     DT(II)=DT(II) - DAMP*D(II)*(1.-0.)                                   NICK.413   
C     TT(II)=TT(II) - DAMP*T(II)*(1.-0.1)                                  NICK.414   
C     II=IGA*(K-1)+I+NWJ2                                                  NICK.415   
C     ZT(II)=ZT(II) - DAMP*Z(II)*(1.-0.)                                   NICK.416   
C     DT(II)=DT(II) - DAMP*D(II)*(1.-0.)                                   NICK.417   
C     TT(II)=TT(II) - DAMP*T(II)*(1.-0.)                                   NICK.418   
C     ENDDO                                                                NICK.419   
                                                                           NICK.420   
C*****troposphere                                                          NICK.421   
C     DO K=2,(NL-1)                                                        NICK.422   
C     DO I=1,IDM                                                           NICK.423   
C     II=IGA*(K-1)+I                                                       NICK.424   
C     ZT(II)=ZT(II) - DAMP*Z(II)*(0.1-0.)                                  NICK.425   
C     DT(II)=DT(II) - DAMP*D(II)*(0.1-0.)                                  NICK.426   
C     TT(II)=TT(II) - DAMP*T(II)*(0.1-0.1)                                 NICK.427   
C     II=IGA*(K-1)+I+NWJ2                                                  NICK.428   
C     ZT(II)=ZT(II) - DAMP*Z(II)*(0.1-0.)                                  NICK.429   
C     DT(II)=DT(II) - DAMP*D(II)*(0.1-0.)                                  NICK.430   
C     TT(II)=TT(II) - DAMP*T(II)*(0.1-0.1)                                 NICK.431   
C     ENDDO                                                                NICK.432   
C     ENDDO                                                                NICK.433   
                                                                           NICK.434   
C*****remove damping from planetary vorticity !                            NICK.435   
C*****stratosphere                                                         NICK.436   
      K=1                                                                  NICK.437   
      I=(K-1)*IGA + 1                                                      NICK.438   
C     ZT(I)=ZT(I) + DAMP*EZ*0.05                                           NICK.439   
                                                                           NICK.440   
C*****troposphere                                                          NICK.441   
      DO 61 K=2,NL-1                                                       NICK.442   
      I=(K-1)*IGA + 1                                                      NICK.443   
C     ZT(I)=ZT(I) + DAMP*EZ*0.05                                           NICK.444   
   61 CONTINUE                                                             NICK.445   
                                                                           NICK.446   
C*****boundary layer                                                       NICK.447   
      I=(NL-1)*IGA + 1                                                     NICK.448   
      IF (LGPDAMP.NE.1) ZT(I)=ZT(I) + DAMP*EZ                              NICK.449   
                                                                           NICK.450   
      ENDIF                                                                NICK.451   
C                                                                          DIFUSE.56    
