...
C*****compile with -r8
     ...
     &IGA=NWJ2*NHEM,IGB=NL*IGA)
      ...
      OPEN(10,FILE='/zemo2/jiaxj/igcm/EXP48/restart.12',
     & form='UNFORMATTED',status='old')
      OPEN(11,
     &FILE='/zemo2/jiaxj/force_diag/UVTP4849after.dat.spec_corrected',
     & form='UNFORMATTED',status='old')
      OPEN(13,FILE='FORCE_51DJF.dat_crtd',form='UNFORMATTED') 
